...
<html lang="en">
	<head>
		...
		<script src="${ctx}/styles/wbox/jquery-1.4.4.min.js" type="text/javascript"></script>
	...
	<body>
		<form id="inputForm" action="${ctx }/security/user/save" method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0" style="margin-top: 0px">
				<c:if test="${not empty usernameMsg || not empty passwordMsg }">
				<tr>
					<td class="td_table_1">
						<span>错误信息：</span>
					</td>
					<td class="td_table_2" colspan="3">
						<font color="red">${usernameMsg }&nbsp;${passwordMsg }</font>
					</td>
				</tr>
				</c:if>
				<tr>
				...
				<tr>
					...
					<td class="td_table_2">
						<input type="text" class="input_240" id="email" name="user.email"
							value="${user.email }" />
					</td>
					<td class="td_table_1">
						<span>性别：</span>
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<frame:select name="user.enabled" type="radio" configName="yesNo" value="${user.enabled == null ? '1' : user.enabled }" cssClass="input_radio"/>
					</td>
				</tr>
 				<tr>
					<td class="td_table_1">
					...
					<td class="td_table_2" colspan="3">
						<input type="hidden" id="parentOrgId" name="user.org" value="${user.org }">
						<input type="text" id="parentOrgName" readonly="readonly" name="parentOrgName" class="input_520" value="${user.orgName }">
